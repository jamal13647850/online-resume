(function($) {
    ...
    NAY.MenuTogglerClose = function() {
        ...
        $('.header-left a, .menu-overlay').on('click', function() {
    ...
    * Masonry
    ...
    NAY.scrollBar = function() {
        if ($(".scroll-bar").exists()) {
            loadScript(plugin_track + 'scroll/jquery.mousewheel.min.js', function() {
    ...
    /* ---------------------------------------------- */
    NAY.Demo = function() {
        $('body').append('<label class="color_switch"><i class="fas fa-sun"></i></label>');
